...
function new_excerpt_more($more) {
       global $post;
	return '<a class="moretag" href="'. get_permalink($post->ID) . '"><div class="cat_read_more_btn"><span class="cat_txt">More</span> <span class="cat_plus">+</span></div></a>';
}
...
add_image_size( 'wpbs-post-thumb', 187, 148, true); 
...
function wp_bootstrap_register_sidebars() {
    ...
    register_sidebar(array(
    	'id' => 'sidebar3',
    	'name' => 'Category Listings Sidebar',
    	'description' => 'Used on the Category Listings page template.',
    	'before_widget' => '<div id="%1$s" class="widget %2$s">',
    	'after_widget' => '</div>',
    	'before_title' => '<h4 class="widgettitle">',
    	'after_title' => '</h4>',
    ...
    register_sidebar(array(
    	...
    	'description' => 'Used on pages such as Site Map and Privacy Policy.',
    	'before_widget' => '<div id="%1$s" class="widget %2$s">',
    	'after_widget' => '</div>',
    	'before_title' => '<h4 class="widgettitle">',
    	'after_title' => '</h4>',
    ...
    register_sidebar(array(
    	'id' => 'sidebar5',
    	'name' => 'The Beautiful Category Page Sidebar',
    	'description' => 'Used on The Beautiful Category page only.',
    	'before_widget' => '<div id="%1$s" class="widget %2$s">',
    	'after_widget' => '</div>',
    	'before_title' => '<h4 class="widgettitle">',
    	'after_title' => '</h4>',
    ...
    register_sidebar(array(
    	'id' => 'sidebar6',
    	'name' => 'The True Category Page Sidebar',
    	'description' => 'Used on The True Category page only.',
    	'before_widget' => '<div id="%1$s" class="widget %2$s">',
    	'after_widget' => '</div>',
    	'before_title' => '<h4 class="widgettitle">',
    	'after_title' => '</h4>',
    ...
    register_sidebar(array(
    	'id' => 'sidebar7',
    	'name' => 'The Good Page Sidebar',
    	'description' => 'Used on The Good Category page only.',
    	'before_widget' => '<div id="%1$s" class="widget %2$s">',
    	'after_widget' => '</div>',
    	'before_title' => '<h4 class="widgettitle">',
    	'after_title' => '</h4>',
...
if( !function_exists("theme_styles") ) {  
    function theme_styles() { 
		...
		wp_register_style( 'animation', get_template_directory_uri() . '/library/css/animate.css', array(), '1.0', 'all' );
		...
		// For mobile devices
		wp_register_style( 'responsive', get_stylesheet_directory_uri() . '/library/css/responsive.css', array(), '1.0', 'all' );
