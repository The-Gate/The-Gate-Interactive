			...
			<div id="content" class="clearfix row">
				...
				<div id="main" class="col col-lg-10 clearfix" role="main">
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
            			...
            			<div id="page_wrapper" class="default">
                 				...
                 				<div id="page_nav">
                   					<div class="casestudy_prev">
                        				<div class="page_prev_txt">
                            				<p><span class="readmoretxt11pt">back</span> <span class="btntxt23pt">{</span> <?php previous_post('%', '', 'yes'); ?></p>
                            			</div>
                        			</div>
                        			<div class="casestudy_next">
                        				<div class="page_next_txt">
                            				<p><?php next_post('%', '', 'yes'); ?> <span class="btntxt23pt">}</span> <span class="readmoretxt11pt">next</span></p>
                            			</div>
                        			</div>
									<div class="clear"></div>
                				</div>								
